        ...
        <div class="form-container">
            ...
            <form action="" method="post">
                <div class="form__group">
                    <input type="email" id="email" name="fieldEmail" placeholder="Email" autocomplete="email" autofocus>
                    <label for="email">Email</label>
                    <!-- Show errors -->
                    <?php if (isset($_SESSION["errors"]["fieldEmail"])) : ?>
                        <p class="fw-semibold text-danger pt-1">
                            <?= $_SESSION["errors"]["fieldEmail"] ?>
                        </p>
                    <?php endif; ?>
                </div>
                <div class="form__group">
                    ...
                    <svg class="eye-close" xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 24 24" fill="#000000">
                    ...
                    <input type="password" id="password" name="fieldPassword" class="password" placeholder="Password">
                    <label for="password">Password</label>
                    <!-- Show errors -->
                    <?php if (isset($_SESSION["errors"]["fieldPassword"])) : ?>
                        <p class="fw-semibold text-danger pt-1">
                            <?= $_SESSION["errors"]["fieldPassword"] ?>
                        </p>
                    <?php endif; ?>
                    <?php unset($_SESSION["errors"]); ?>
                </div>
                <div class="form__group form__group-option">
