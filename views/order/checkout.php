<div class="checkout-container" style="padding: 0 1.3rem;">
    <div class="grid wide">
        <form action="?act=place-order&id=<?= $_SESSION["user"]['id'] ?>" method="post">
            <div class="row d-flex gap-5">
                <div class="col-12 col-sm-5">
                        ...
                        <a href="?act=home-page" class="header__navbar-logo">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" version="1.1" viewBox="0 0 300 118.62" xml:space="preserve">
                                <g fill="#000" stroke-width="1.1801">
                                    <path class="st0" d="m96.307 69.753c8.3784 11.447 18.881 12.037 18.881 12.037h18.291l8.2604-12.037z" />
                                    <path class="st0" d="m73.414 51.698c8.3784 11.447 18.881 12.037 18.881 12.037h53.575l8.2604-12.037z" />
                                    <path class="st0" d="m50.639 33.643c8.3784 11.447 18.881 12.037 18.881 12.037h88.741l8.2604-12.037z" />
                                    <path class="st0" d="m8.9828 3.5518c16.875 22.893 37.762 24.073 37.762 24.073h131.22l-43.544 63.369c-8.7324 12.627 12.627 24.073 12.627 24.073l60.183-87.442s20.887-1.1801 37.762-24.073z" />
                                    <path class="st0" d="m291.02 3.5518h-29.266c-16.875 22.893-37.762 24.073-37.762 24.073h21.241l-43.544 63.369c-8.7324 12.627 12.627 24.073 12.627 24.073z" />
                                </g>
                            </svg>
                        </a>
                        <a href="?act=review-cart" class="header__navbar-menu-link header__navbar-icon-btn cart-icon">
                    ...
                    <h5 class="text-secondary text-center pt-5 mb-4">Express checkout</h5>

                    <div class="d-flex gap-4 p-4" style="background-color: #f2f2f2; border-radius: 10px;">
                        <button class="w-100 btn py-0 shadow rounded-3 border">
                    ...
                    <h5 class="text-secondary text-center mt-4 or">OR</h5>
                    ...
                    <div class="mt-5 pb-4 border-bottom">
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center lh-base pt-2">
                            ...
                            <div id="span">
                                <a href="?act=logout" class="link-hover-100">Logout</a>
                            </div>
                        </div>
                    </div>

                    <div class="mt-5 pb-4 fs-4 border-bottom">
                        <!-- Show errors -->
                        <?php if (!empty($_SESSION["errors"]["missingInfo"])) : ?>
                            <p class="text-center my-4">
                                <span class="bg-label-danger"><?= $_SESSION["errors"]["missingInfo"] ?></span>
                            </p>
                        <?php endif; ?>
                    ...
                    <div class="mt-5 pb-4 fs-4">
                        <h3 class="fs-2 fw-bold">Payment</h3>
                        <p class="text-secondary py-4">All transactions are secure and encrypted.</p>

                        <div class="payment-box mb-3 d-flex align-items-center border ps-4" style="height: 50px;" onclick="toggleCheckbox('cod')">
                            <div class="form-check lh-base">
                                <input class="form-check-input" type="radio" name="method" value="0" id="cod">
                                <label class="form-check-label" for="cod">Cash on Delivery</label>
                            </div>
                        </div>
                        <div class="payment-box mb-3 d-flex align-items-center border ps-4" style="height: 50px;" onclick="toggleCheckbox('online')">
                            <div class="form-check lh-base">
                                <input class="form-check-input" type="radio" name="method" value="1" id="online">
                                <label class="form-check-label" for="online">Online Payment</label>
                            </div>
                        </div>
                        <!-- Show errors -->
                        <?php if (!empty($_SESSION["errors"]["missingMethod"])) : ?>
                            <p class="text-center my-4">
                                <span class="bg-label-danger"><?= $_SESSION["errors"]["missingMethod"] ?></span>
                            </p>
                        <?php endif; ?>
                    ...
                    <div class="hide-on-mobile">
                        ...
                        <ul class="d-flex flex-wrap gap-3 justify-content-between mb-5">
                            ...
                            <a href="?act=contact" class="text-danger fs-5 text-decoration-underline">CONTACT</a>
                        </ul>
                    </div>
                </div>
