...
// Khai báo các biến môi trường Global
...
define('BASE_URL'      , 'http://localhost/project/furniland/');
define('BASE_URL_ADMIN', 'http://localhost/project/furniland/admin/');

define('EMAIL'   , 'niboss458@gmail.com');
define('PASSWORD', 'qjkk ttji kdxq zbpj');